...
Security issues in the MCP server (`GdbMiBridge.Mcp`) and MI client library (`GdbMiClient`) are in scope. Issues in external dependencies (GDB, .NET runtime) should be reported to their respective maintainers.
